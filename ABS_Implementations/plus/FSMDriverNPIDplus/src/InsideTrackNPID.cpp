...
const float InsideTrackNPID::Knp = 0.2435; /*best = 0.2435*/
const float InsideTrackNPID::Tni = 0.532; /* best = 0.532*/
const float InsideTrackNPID::Tnd = 0.00989; /*best = 0.00989*/
